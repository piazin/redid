...
router.get('/admin', auth, adminControllers.render_painel);
router.get('/admin/users', auth, adminControllers.render_users);

router
  .route('/admin/create')
  .get(auth, adminControllers.render_create_user)
  .post(auth, adminControllers.to_save_user);

router
  .route('/admin/edit/:id')
  .get(adminControllers.render_edit_user)
  .post(adminControllers.update_user);
